...
采用游戏目录的**官方中英双语**本地化与原始图标素材，深色科幻风界面，支持一键中英切换。
...
- 🌐 **中英双语**：顶栏一键切换中/EN，节点/详情/侧栏/标题全部双语，偏好自动记忆
- 🎋 **三大学科切换**：物理学（162）/ 社会学（311）/ 工程学（189），ELK 分层算法自动布局
- 🔗 **完整前置关系**：582 条科技树边，含 13 个「任一前置」OR 组，hover 高亮关联连线
- 🔍 **搜索 + 多维筛选**：按中英文名/ID 搜索，按层级(T0–T5)、13 个子类别、稀有/危险/起始/可逆向 筛选
- 📋 **详情面板**：点击节点看成本（数值+原宏）、权重、官方中英描述、前置/解锁、实际游戏效果、DLC 来源
- 🎁 **可重复科技**：默认折叠，可展开
...
| 英文本地化 | `localisation/english/*.yml` |
